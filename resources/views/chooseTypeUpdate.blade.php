      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-3 marginChoseTeacher">
            ...
            <a class="btn btn-primary buttonChooseTeacher"  href="{{ url('/choose_type_teacher_update') }}" >Professor</a>
          </div>
          <div class="col-md-3 marginBottomChose">
            <img src="../../imagens/student2.png" alt="Responsive image" width="140" >
            <a class="btn btn-primary buttonChooseStudent"  href="{{ url('/choose_type_student_update') }}" >Aluno</a>
          </div>
        </div>
      </div>
    </section>
