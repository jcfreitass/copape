  ...
  <body>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 text-center marginHeader">
            <h1 style="color: #14395f"> Alterar Senha</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 marginCardPass">
                <div class="card" style="border-color: #4c7aa9;">
                    <div class="card-body" style="background: #4c7aa9;">
                        @if (session('error'))
                            <div style="width:38%!important; margin-left:2%;" class="alert alert-danger">
                              <p> Erro na operação </p>
                            </div>
                        @endif
                        @if (session('success'))
                            <div style="width:38%!important; margin-left:2%;"class="alert alert-success">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('changePassword') }}">
                            ...
                            <div class="form-group{{ $errors->has('current-password') ? ' has-error' : '' }}">
                                <label for="new-password" class="col-md-4 control-label letraForm">Senha</label>
                            ...
                            <div class="form-group{{ $errors->has('new-password') ? ' has-error' : '' }}">
                                <label for="new-password" class="col-md-4 control-label letraForm">Nova Senha</label>
                            ...
                            <div class="form-group">
                                <label for="new-password-confirm" class="col-md-4 control-label letraForm">Confirmar Senha</label>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                    <button type="submit" class="btn btn-success btn-lg buttonCardPass">
                                        Salvar
                                    </button>
                                </div>
                            </div>
